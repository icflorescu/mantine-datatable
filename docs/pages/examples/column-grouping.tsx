...
import { Container, Code, List } from "@mantine/core";
...
export default function Page({ code }: InferGetStaticPropsType<typeof getStaticProps>) {
  return <Container>
    <PageTitle of={PATH} />
    <PageText>
      Sometimes a sub-set of data is very closely related. In such a case it might make sense to group
      the headers of those columns. This can be easily achieved by specifying <Code>groups</Code> instead of <Code>columns</Code>.
    </PageText>
    <PageText>
      Each group requires requires the following properties:
      <List>
        <List.Item>
    ...
    <PageText>
      Groups are hidden if they don't have any visible columns. This could be the result of all columns being hidden
       due to the <Code>hidden</Code> or <Code>visibleMdediaQuery</Code> attribure. Or by simply providing an empty array of columns.
