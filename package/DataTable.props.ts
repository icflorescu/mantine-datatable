...
export type DataTableColumn<T> = {
  /**
   * Column property accessor (use dot-notation for nested objects property drilling)
   */
  accessor: string;
  /**
   ...
   * `upperFirst` & `lowerCase` to the provided column name
   */
  title?: ReactNode;
  /**
...
export type DataTableSortStatus = {
  /**
   * Sort column accessor (use dot-notation for nested objects property drilling)
   */
...
export type DataTableProps<T> = {
  ...
  /**
   * Accessor to use as unique record key (use dot-notation for nested objects property drilling); defaults to `id`
   */
  idAccessor?: string;
  /**
